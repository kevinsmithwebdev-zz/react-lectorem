...
export const getSpacer = text =>
  ENDING_PUNCTUATION.includes(text?.slice(-1)) ? '  ' : ' ';
export const getHasModalInformation = lect =>
  !!lect.explanation || !!lect.translation;
...
const Lect = ({ lect, shouldHighlight, showModal }) => {
  ...
  const handleClick =
    hasModalInformation && /* istanbul ignore next */ (() => showModal(lect));
